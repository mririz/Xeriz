...
var prefix = '&'
var token = 'NjM5MTY3OTg5NTc2NDk5MjIx.Xe6S6Q.H-JIomSVpB8wknVdONNkIYKBi7A'
...
client.on('message', async message =>{
        if(message.content.startsWith(prefix + "clear")){
          ...
          if(!message.member.hasPermission("BAN_MEMBERS")) return message.reply(":warning: vous n'avez pas la permission `BAN_MEMBERS` :warning:")
